...
export default function PropertyDetailPage() {
  ...
  // EMI state — loan amount defaults to property price
  const [showEMI, setShowEMI] = useState(false);
  const [loanAmount, setLoanAmount] = useState(0); // 0 = not initialized yet
  const [rate, setRate] = useState(8.5);
  const [years, setYears] = useState(20);

  // Initialize loan amount to property price when property loads
  const effectiveLoan = loanAmount || (property?.price ?? 0);
  ...
  if (loading) {
    return (
      <div className="max-w-5xl mx-auto px-4 sm:px-6 py-6 sm:py-10">
        <div className="h-4 w-48 bg-surface-light rounded animate-pulse mb-4" />
        <div className="rounded-xl border border-surface-border h-80 animate-pulse bg-surface-light mb-6" />
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          <div className="lg:col-span-2 space-y-4">
            <div className="h-8 w-2/3 bg-surface-light rounded animate-pulse" />
            <div className="h-4 w-1/3 bg-surface-light rounded animate-pulse" />
  ...
  if (!property) {
    return (
      <div className="max-w-4xl mx-auto px-4 py-20 text-center">
        ...
        <p className="text-muted mb-6">This property doesn&apos;t exist or has been removed.</p>
        <Link href="/noida"><Button>Browse Properties</Button></Link>
      </div>
    );
  }
  ...
  return (
    <div className="max-w-5xl mx-auto px-4 sm:px-6 py-6 sm:py-10">
      ...
      {/* Image Carousel */}
      <div className="relative rounded-xl border border-surface-border mb-6 overflow-hidden">
      ...
      {/* AI Insights — Full Width, Top Priority */}
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mt-6">
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          {/* Location — Map & Satellite Side by Side */}
          <Card className="p-5">
        ...
        <div className="space-y-4">
          ...
          <Card className="p-5 sticky top-20">
            ...
            <div className="flex flex-col gap-2.5">
              <a
                href={`https://wa.me/919582806827?text=${encodeURIComponent(whatsappMsg)}`}
